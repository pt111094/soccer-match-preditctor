...
def proj():
	workbook = xlrd.open_workbook('13-14_match_data.xls')
	worksheet = workbook.sheet_by_name('13-14_match_data')
	...
	for col in rows:
		d[col] = i
		i += 1
	files = ["07-08.csv","08-09.csv","09-10.csv","10-11.csv","11-12.csv","12-13.csv"]
	team_positions = {}
	average_position = {}
	positions = []
	for f in files:
