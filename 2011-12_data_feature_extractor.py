...
def proj():
	workbook = xlrd.open_workbook('11-12_match_data.xls')
	worksheet = workbook.sheet_by_name('11-12_match_data')
	...
	for col in rows:
		d[col] = i
		i += 1
	files = ["05-06.csv","06-07.csv","07-08.csv","08-09.csv","09-10.csv","10-11.csv"]
	team_positions = {}
	average_position = {}
	positions = []
	for f in files:
	...
	teams = []
	teams.append('teams')
	with open("11-12.csv", 'rb') as csvfile:
