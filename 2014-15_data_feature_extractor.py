...
def proj():
	workbook = xlrd.open_workbook('14-15_match_data.xls')
	worksheet = workbook.sheet_by_name('14-15_match_data')
	...
	for col in rows:
		d[col] = i
		i += 1
	files = ["08-09.csv","09-10.csv","10-11.csv","11-12.csv","12-13.csv","13-14.csv"]
	team_positions = {}
	average_position = {}
	positions = []
	for f in files:
